...
from backend.services.embedding import TextEmbedder
...
def _calculate_semantic_similarity(skill: str, text: str, embedder: TextEmbedder) -> float:
    #similarity = (A · B) / (|A| × |B|)
...
def _skill_matches(skill: str, text: str, embedder: TextEmbedder, threshold: float) -> Tuple[bool, float]:
